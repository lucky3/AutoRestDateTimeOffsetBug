...
namespace ConsoleApplication1
{
    public static partial class AccountExtensions
    {
        ...
        /// Reference to the ConsoleApplication1.IAccount.
        /// </param>
        /// <param name='model'>
        /// Required.
        /// </param>
        ...
        {
            Microsoft.Rest.HttpOperationResponse<System.Collections.Generic.IList<ConsoleApplication1.Models.ExternalLoginViewModel>> result = await operations.GetExternalLoginsWithOperationResponseAsync(returnUrl, generateState, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<ConsoleApplication1.Models.ManageInfoViewModel> result = await operations.GetManageInfoWithOperationResponseAsync(returnUrl, generateState, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<ConsoleApplication1.Models.UserInfoViewModel> result = await operations.GetUserInfoWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
